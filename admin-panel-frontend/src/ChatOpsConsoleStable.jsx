...
const pickApiBase = async () => {
    ...
    const portList = (localStorage.getItem('theLocal.portCandidates') || '8088,8001,8000,8002')
    ...
    // Fallback default
    return candidates[0] || 'http://localhost:8088';
};
let API_BASE = 'http://localhost:8088'; // will be updated asynchronously
